  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:bg-[radial-gradient(circle_at_var(--x)_var(--y),_hsl(var(--primary)/0.25)_0,_transparent_40vw)]',
        'dark:before:bg-[radial-gradient(circle_at_var(--x)_var(--y),_hsl(var(--primary)/0.3)_0,_transparent_30vw)]',
