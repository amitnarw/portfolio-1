...
export function SkillsSection() {
  return (
    ...
    >
      <h2 className="mb-12 text-center text-4xl font-bold tracking-tight text-primary md:text-5xl">My Skills</h2>
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        {skillCategories.map((category) => (
            <motion.div key={category.name} className="rounded-lg border bg-card p-6" variants={itemVariants}>
