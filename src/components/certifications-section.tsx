        ...
        <div className="space-y-4 md:col-span-2 md:order-1">
          {certifications.map((item, index) => (
            <div
              ...
              className="certification-item group border-b border-dotted border-foreground last:border-b-0"
            >
              <Link
                href={item.url}
                target="_blank"
        ...
        <div className="md:col-span-1 md:order-2 relative">
          <div className="sticky top-1/2 -translate-y-1/2 pl-8">
           ...
           <div 
              ...
              style={{
                backgroundImage: 'linear-gradient(to bottom, hsl(var(--foreground)) 40%, transparent 40%)',
